function [success] = eyetribe_calibrate_scifest(connection, window)
...
if strcmp(message, 'success')
    ...
    while running == 1
        ...
        for i = 1:numel(x)
            ...
            disp(['Sending: Calibration pointstart;x=' num2str(x(i)) ',y=' num2str(y(i))]);
            ...
            disp(['Sending: Calibration pointend']);
        ...
        if running == 0
            ...
            if strcmp(message(1:7), 'success') == 0
                ...
                disp(['result = ' message(9:length(message)) ';']);
        ...
        % draw text on Screen
        DrawFormattedText(window, resulttext, 'center', round(h/4), 0);
        % show results!
        Screen('Flip', window);
